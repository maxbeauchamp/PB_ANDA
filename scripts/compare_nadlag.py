...
type_obs = sys.argv[1]
workpath = "/home3/scratch/mbeaucha/compare_AnDA_nadlag_"+type_obs
...
plt.plot(ldate,nrmse_Post_AnDA_nadir_0,color=col[0],linewidth=.5,label='post-AnDA (nadir, lag=0)')
plt.plot(ldate,nrmse_Post_AnDA_nadir_1,color=col[1],linewidth=.5,label='post-AnDA (nadir, lag=1)')
plt.plot(ldate,nrmse_Post_AnDA_nadir_2,color=col[2],linewidth=.5,label='post-AnDA (nadir, lag=2)')
plt.plot(ldate,nrmse_Post_AnDA_nadir_3,color=col[3],linewidth=.5,label='post-AnDA (nadir, lag=3)')
plt.plot(ldate,nrmse_Post_AnDA_nadir_4,color=col[4],linewidth=.5,label='post-AnDA (nadir, lag=4)')
plt.plot(ldate,nrmse_Post_AnDA_nadir_5,color=col[5],linewidth=.5,label='post-AnDA (nadir, lag=5)')
plt.ylabel('nRMSE')
...
axes2 = plt.twinx()
width=0.75
p1 = axes2.bar(ldate, nadcov_0, width,color=col[0],alpha=0.25)
p2 = axes2.bar(ldate, nadcov_1, width, bottom=nadcov_0, color=col[1], alpha=0.25)
p3 = axes2.bar(ldate, nadcov_2, width, bottom=nadcov_1, color=col[2], alpha=0.25)
p4 = axes2.bar(ldate, nadcov_3, width, bottom=nadcov_2, color=col[3], alpha=0.25)
p5 = axes2.bar(ldate, nadcov_4, width, bottom=nadcov_3, color=col[4], alpha=0.25)
p6 = axes2.bar(ldate, nadcov_5, width, bottom=nadcov_4, color=col[5], alpha=0.25)
axes2.set_ylim(0, 1)
...
# first axis with nRMSE time series
col = plt.matplotlib.cm.jet(np.linspace(0,1,6))
plt.plot(ldate,nrmse_Post_AnDA_nadirswot_0,color=col[0],linewidth=.5,label='post-AnDA (nadir, lag=0)')
plt.plot(ldate,nrmse_Post_AnDA_nadirswot_1,color=col[1],linewidth=.5,label='post-AnDA (nadir, lag=1)')
plt.plot(ldate,nrmse_Post_AnDA_nadirswot_2,color=col[2],linewidth=.5,label='post-AnDA (nadir, lag=2)')
plt.plot(ldate,nrmse_Post_AnDA_nadirswot_3,color=col[3],linewidth=.5,label='post-AnDA (nadir, lag=3)')
plt.plot(ldate,nrmse_Post_AnDA_nadirswot_4,color=col[4],linewidth=.5,label='post-AnDA (nadir, lag=4)')
plt.plot(ldate,nrmse_Post_AnDA_nadirswot_5,color=col[5],linewidth=.5,label='post-AnDA (nadir, lag=5)')
plt.ylabel('nRMSE')
plt.xlabel('Time (days)')
plt.xticks(rotation=45, ha='right')
plt.gcf().autofmt_xdate()
...
axes2 = plt.twinx()
width=0.75
p1 = axes2.bar(ldate, nadswotcov_0, width,color=col[0],alpha=0.25)
p2 = axes2.bar(ldate, nadswotcov_1, width, bottom=nadswotcov_0, color=col[1], alpha=0.25)
p3 = axes2.bar(ldate, nadswotcov_2, width, bottom=nadswotcov_1, color=col[2], alpha=0.25)
p4 = axes2.bar(ldate, nadswotcov_3, width, bottom=nadswotcov_2, color=col[3], alpha=0.25)
p5 = axes2.bar(ldate, nadswotcov_4, width, bottom=nadswotcov_3, color=col[4], alpha=0.25)
p6 = axes2.bar(ldate, nadswotcov_5, width, bottom=nadswotcov_4, color=col[5], alpha=0.25)
axes2.set_ylim(0, 1)
axes2.set_ylabel('Spatial Coverage (%)')
axes2.margins(x=0)
