...
type_obs = sys.argv[1]
workpath = "/home3/scratch/mbeaucha/compare_ConvAE_nadlag_"+type_obs
...
# NADLAG = 0
file_results_nadir='/home3/scratch/mbeaucha/resIA_nadir_nadlag_0_'+type_obs+'/saved_path_FP_ConvAE_WOmissing.pickle'
with open(file_results_nadir, 'rb') as handle:
    itrp_FP_ConvAE_nadir_0 = pickle.load(handle)[2]
file_results_nadirswot='/home3/scratch/mbeaucha/resIA_nadirswot_nadlag_0_'+type_obs+'/saved_path_FP_ConvAE_WOmissing.pickle'
with open(file_results_nadirswot, 'rb') as handle:
    itrp_FP_ConvAE_nadirswot_0 = pickle.load(handle)[2]
# NADLAG = 1
file_results_nadir='/home3/scratch/mbeaucha/resIA_nadir_nadlag_1_'+type_obs+'/saved_path_FP_ConvAE_WOmissing.pickle'
with open(file_results_nadir, 'rb') as handle:
    itrp_FP_ConvAE_nadir_1 = pickle.load(handle)[2]
file_results_nadirswot='/home3/scratch/mbeaucha/resIA_nadirswot_nadlag_1_'+type_obs+'/saved_path_FP_ConvAE_WOmissing.pickle'
with open(file_results_nadirswot, 'rb') as handle:
    itrp_FP_ConvAE_nadirswot_1 = pickle.load(handle)[2]
# NADLAG = 2
file_results_nadir='/home3/scratch/mbeaucha/resIA_nadir_nadlag_2_'+type_obs+'/saved_path_FP_ConvAE_WOmissing.pickle'
with open(file_results_nadir, 'rb') as handle:
    itrp_FP_ConvAE_nadir_2 = pickle.load(handle)[2]
file_results_nadirswot='/home3/scratch/mbeaucha/resIA_nadirswot_nadlag_2_'+type_obs+'/saved_path_FP_ConvAE_WOmissing.pickle'
with open(file_results_nadirswot, 'rb') as handle:
    itrp_FP_ConvAE_nadirswot_2 = pickle.load(handle)[2]
# NADLAG = 3
file_results_nadir='/home3/scratch/mbeaucha/resIA_nadir_nadlag_3_'+type_obs+'/saved_path_FP_ConvAE_WOmissing.pickle'
with open(file_results_nadir, 'rb') as handle:
    itrp_FP_ConvAE_nadir_3 = pickle.load(handle)[2]
file_results_nadirswot='/home3/scratch/mbeaucha/resIA_nadirswot_nadlag_3_'+type_obs+'/saved_path_FP_ConvAE_WOmissing.pickle'
with open(file_results_nadirswot, 'rb') as handle:
    itrp_FP_ConvAE_nadirswot_3 = pickle.load(handle)[2]
# NADLAG = 4
file_results_nadir='/home3/scratch/mbeaucha/resIA_nadir_nadlag_4_'+type_obs+'/saved_path_FP_ConvAE_WOmissing.pickle'
with open(file_results_nadir, 'rb') as handle:
    itrp_FP_ConvAE_nadir_4 = pickle.load(handle)[2]
file_results_nadirswot='/home3/scratch/mbeaucha/resIA_nadirswot_nadlag_4_'+type_obs+'/saved_path_FP_ConvAE_WOmissing.pickle'
with open(file_results_nadirswot, 'rb') as handle:
    itrp_FP_ConvAE_nadirswot_4 = pickle.load(handle)[2]
# NADLAG = 5
file_results_nadir='/home3/scratch/mbeaucha/resIA_nadir_nadlag_5_'+type_obs+'/saved_path_FP_ConvAE_WOmissing.pickle'
with open(file_results_nadir, 'rb') as handle:
    itrp_FP_ConvAE_nadir_5 = pickle.load(handle)[2]
file_results_nadirswot='/home3/scratch/mbeaucha/resIA_nadirswot_nadlag_5_'+type_obs+'/saved_path_FP_ConvAE_WOmissing.pickle'
with open(file_results_nadirswot, 'rb') as handle:
